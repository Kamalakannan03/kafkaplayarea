...
public class UserDto extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6664168558511505765L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserDto\",\"namespace\":\"com.kafkaproducer.producerDemo.dto\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"location\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public UserDto(java.lang.Integer id, java.lang.CharSequence name, java.lang.CharSequence location) {
    this.id = id;
    this.name = name;
   ...
   */
  public static com.kafkaproducer.producerDemo.dto.UserDto.Builder newBuilder() {
    return new com.kafkaproducer.producerDemo.dto.UserDto.Builder();
  }
   ...
   * @return A new UserDto RecordBuilder
   */
  public static com.kafkaproducer.producerDemo.dto.UserDto.Builder newBuilder(com.kafkaproducer.producerDemo.dto.UserDto.Builder other) {
    return new com.kafkaproducer.producerDemo.dto.UserDto.Builder(other);
  }
   ...
   * @return A new UserDto RecordBuilder
   */
  public static com.kafkaproducer.producerDemo.dto.UserDto.Builder newBuilder(com.kafkaproducer.producerDemo.dto.UserDto other) {
    return new com.kafkaproducer.producerDemo.dto.UserDto.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserDto>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafkaproducer.producerDemo.dto.UserDto.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafkaproducer.producerDemo.dto.UserDto other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkaproducer.producerDemo.dto.UserDto.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkaproducer.producerDemo.dto.UserDto.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkaproducer.producerDemo.dto.UserDto.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkaproducer.producerDemo.dto.UserDto.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkaproducer.producerDemo.dto.UserDto.Builder setLocation(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkaproducer.producerDemo.dto.UserDto.Builder clearLocation() {
      location = null;
